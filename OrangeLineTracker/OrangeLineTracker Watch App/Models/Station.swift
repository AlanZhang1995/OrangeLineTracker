...
/// Blue Line runs from Baypointe to Santa Teresa
/// Station IDs are from 511.org SIRI API
enum BlueLineStations {
    /// All Blue Line stations in geographic order (North to South)
    /// Note: Some station IDs are placeholders and should be verified with 511.org API
    static let stations: [Station] = [
        Station(id: "64801", lineId: "Blue", name: "Baypointe", shortName: "BPT", order: 0, platformIds: ["N": "64801", "S": "64806"]),
        Station(id: "64800", lineId: "Blue", name: "Champion", shortName: "CHP", order: 1, platformIds: ["N": "64800", "S": "64807"]),
        Station(id: "64799", lineId: "Blue", name: "Lick Mill", shortName: "LML", order: 2, platformIds: ["N": "64799", "S": "64808"]),
        Station(id: "64798", lineId: "Blue", name: "Great America", shortName: "GAM", order: 3, platformIds: ["N": "64798", "S": "64809"]),
        Station(id: "64797", lineId: "Blue", name: "Old Ironsides", shortName: "OIS", order: 4, platformIds: ["N": "64797", "S": "64810"]),
        Station(id: "64762", lineId: "Blue", name: "Tasman", shortName: "TSM", order: 5, platformIds: ["N": "64762", "S": "64763"]),
        Station(id: "64766", lineId: "Blue", name: "Karina", shortName: "KRN", order: 6, platformIds: ["N": "64766", "S": "64767"]),
        Station(id: "64768", lineId: "Blue", name: "Component", shortName: "CMP", order: 7, platformIds: ["N": "64768", "S": "64769"]),
        Station(id: "64770", lineId: "Blue", name: "Bonaventura", shortName: "BNV", order: 8, platformIds: ["N": "64770", "S": "64771"]),
        Station(id: "64772", lineId: "Blue", name: "Metro/Airport", shortName: "APT", order: 9, platformIds: ["N": "64772", "S": "64773"]),
        Station(id: "64774", lineId: "Blue", name: "Gish", shortName: "GSH", order: 10, platformIds: ["N": "64774", "S": "64775"]),
        Station(id: "64776", lineId: "Blue", name: "Civic Center", shortName: "CVC", order: 11, platformIds: ["N": "64776", "S": "64777"]),
        Station(id: "64778", lineId: "Blue", name: "Japantown/Ayer", shortName: "JPN", order: 12, platformIds: ["N": "64778", "S": "64779"]),
        Station(id: "64780", lineId: "Blue", name: "St. James", shortName: "STJ", order: 13, platformIds: ["N": "64780", "S": "64781"]),
        Station(id: "64782", lineId: "Blue", name: "Santa Clara", shortName: "STC", order: 14, platformIds: ["N": "64782", "S": "64783"]),
        Station(id: "64784", lineId: "Blue", name: "Paseo de San Antonio", shortName: "PSA", order: 15, platformIds: ["N": "64784", "S": "64785"]),
        Station(id: "64822", lineId: "Blue", name: "San Antonio", shortName: "SAN", order: 16, platformIds: ["N": "64822", "S": "64823"]),
        Station(id: "64824", lineId: "Blue", name: "Convention Center", shortName: "CNV", order: 17, platformIds: ["N": "64824", "S": "64825"]),
        Station(id: "64826", lineId: "Blue", name: "San Fernando", shortName: "SFN", order: 18, platformIds: ["N": "64826", "S": "64827"]),
        Station(id: "64828", lineId: "Blue", name: "Virginia", shortName: "VRG", order: 19, platformIds: ["N": "64828", "S": "64829"]),
        Station(id: "64830", lineId: "Blue", name: "Tamien", shortName: "TMN", order: 20, platformIds: ["N": "64830", "S": "64831"]),
        Station(id: "64832", lineId: "Blue", name: "Curtner", shortName: "CRT", order: 21, platformIds: ["N": "64832", "S": "64833"]),
        Station(id: "64834", lineId: "Blue", name: "Capitol", shortName: "CPT", order: 22, platformIds: ["N": "64834", "S": "64835"]),
        Station(id: "64836", lineId: "Blue", name: "Branham", shortName: "BRH", order: 23, platformIds: ["N": "64836", "S": "64837"]),
        Station(id: "64838", lineId: "Blue", name: "Ohlone/Chynoweth", shortName: "OHL", order: 24, platformIds: ["N": "64838", "S": "64839"]),
        Station(id: "64840", lineId: "Blue", name: "Blossom Hill", shortName: "BLH", order: 25, platformIds: ["N": "64840", "S": "64841"]),
        Station(id: "64842", lineId: "Blue", name: "Snell", shortName: "SNL", order: 26, platformIds: ["N": "64842", "S": "64843"]),
        Station(id: "64844", lineId: "Blue", name: "Cottle", shortName: "CTL", order: 27, platformIds: ["N": "64844", "S": "64845"]),
        Station(id: "64846", lineId: "Blue", name: "Santa Teresa", shortName: "STT", order: 28, platformIds: ["N": "64846", "S": "64847"])
    ]
...
/// Green Line runs from Old Ironsides to Winchester
/// Station IDs are from 511.org SIRI API
enum GreenLineStations {
    ...
    static let stations: [Station] = [
        ...
        Station(id: "64796", lineId: "Green", name: "Reamwood", shortName: "RWD", order: 1, platformIds: ["N": "64796", "S": "64811"]),
        Station(id: "64795", lineId: "Green", name: "Vienna", shortName: "VNA", order: 2, platformIds: ["N": "64795", "S": "64812"]),
        Station(id: "64794", lineId: "Green", name: "Fair Oaks", shortName: "FOK", order: 3, platformIds: ["N": "64794", "S": "64813"]),
        Station(id: "64793", lineId: "Green", name: "Crossman", shortName: "CRS", order: 4, platformIds: ["N": "64793", "S": "64814"]),
        Station(id: "64792", lineId: "Green", name: "Borregas", shortName: "BRG", order: 5, platformIds: ["N": "64792", "S": "64815"]),
        Station(id: "64791", lineId: "Green", name: "Lockheed Martin", shortName: "LMT", order: 6, platformIds: ["N": "64791", "S": "64816"]),
        Station(id: "64762", lineId: "Green", name: "Tasman", shortName: "TSM", order: 7, platformIds: ["N": "64762", "S": "64763"]),
        Station(id: "64766", lineId: "Green", name: "Karina", shortName: "KRN", order: 8, platformIds: ["N": "64766", "S": "64767"]),
        Station(id: "64768", lineId: "Green", name: "Component", shortName: "CMP", order: 9, platformIds: ["N": "64768", "S": "64769"]),
        Station(id: "64770", lineId: "Green", name: "Bonaventura", shortName: "BNV", order: 10, platformIds: ["N": "64770", "S": "64771"]),
        Station(id: "64772", lineId: "Green", name: "Metro/Airport", shortName: "APT", order: 11, platformIds: ["N": "64772", "S": "64773"]),
        Station(id: "64774", lineId: "Green", name: "Gish", shortName: "GSH", order: 12, platformIds: ["N": "64774", "S": "64775"]),
        Station(id: "64776", lineId: "Green", name: "Civic Center", shortName: "CVC", order: 13, platformIds: ["N": "64776", "S": "64777"]),
        Station(id: "64778", lineId: "Green", name: "Japantown/Ayer", shortName: "JPN", order: 14, platformIds: ["N": "64778", "S": "64779"]),
        Station(id: "64780", lineId: "Green", name: "St. James", shortName: "STJ", order: 15, platformIds: ["N": "64780", "S": "64781"]),
        Station(id: "64782", lineId: "Green", name: "Santa Clara", shortName: "STC", order: 16, platformIds: ["N": "64782", "S": "64783"]),
        Station(id: "64784", lineId: "Green", name: "Paseo de San Antonio", shortName: "PSA", order: 17, platformIds: ["N": "64784", "S": "64785"]),
        Station(id: "64822", lineId: "Green", name: "San Antonio", shortName: "SAN", order: 18, platformIds: ["N": "64822", "S": "64823"]),
        Station(id: "64824", lineId: "Green", name: "Convention Center", shortName: "CNV", order: 19, platformIds: ["N": "64824", "S": "64825"]),
        Station(id: "64848", lineId: "Green", name: "Children's Discovery Museum", shortName: "CDM", order: 20, platformIds: ["N": "64848", "S": "64849"]),
        Station(id: "64850", lineId: "Green", name: "Race", shortName: "RCE", order: 21, platformIds: ["N": "64850", "S": "64851"]),
        Station(id: "64852", lineId: "Green", name: "Fruitdale", shortName: "FRD", order: 22, platformIds: ["N": "64852", "S": "64853"]),
        Station(id: "64854", lineId: "Green", name: "Bascom", shortName: "BSC", order: 23, platformIds: ["N": "64854", "S": "64855"]),
        Station(id: "64856", lineId: "Green", name: "Hamilton", shortName: "HML", order: 24, platformIds: ["N": "64856", "S": "64857"]),
        Station(id: "64858", lineId: "Green", name: "Downtown Campbell", shortName: "DTC", order: 25, platformIds: ["N": "64858", "S": "64859"]),
        Station(id: "64860", lineId: "Green", name: "Winchester", shortName: "WNC", order: 26, platformIds: ["N": "64860", "S": "64861"])
    ]
